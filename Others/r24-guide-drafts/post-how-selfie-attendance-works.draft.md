---
title: "How Selfie-Based Attendance Works in OpenHRApp"
slug: how-selfie-attendance-works
excerpt: "A deep dive into OpenHRApp's selfie-based attendance system. Learn how photo verification eliminates buddy punching, how GPS confirms location, and how to set it up for your team."
authorName: "OpenHRApp Team"
category: "Feature Guide"
publishedAt: "2026-03-26T16:31:00+00:00"
---

# How Selfie-Based Attendance Works in OpenHRApp

One of OpenHRApp's standout features is selfie-based attendance tracking. Instead of fingerprint scanners, RFID cards, or old-school punch clocks, employees simply take a selfie using their phone — and the system captures their photo, GPS location, and timestamp all together. This guide explains exactly how it works under the hood and how to use it effectively.

## What happens when an employee checks in?
...
## How does a selfie stop buddy punching?
...
## Should you use Office or Factory mode?
...
Designed for manufacturing, production, and shift-based environments. The important difference: **lateness is not calculated for Factory punches**. A Factory check-in is always recorded as present regardless of the time, and is tagged with a FACTORY marker in the remarks. Choosing the wrong mode therefore changes the record, so make sure people know which applies to them. Key characteristics:
...
## What is recorded for each punch?
...
## What if the camera or GPS does not work?
...
*OpenHRApp's attendance system is completely free, with no limits on employees, check-ins, or storage. [Start tracking attendance today](/).*
