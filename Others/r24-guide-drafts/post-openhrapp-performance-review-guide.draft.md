---
title: "A Guide to OpenHRApp's Performance Review Module"
slug: openhrapp-performance-review-guide
excerpt: "Learn how to set up and run performance review cycles in OpenHRApp. From defining competencies to finalizing reviews, this guide covers the complete process for HR administrators and managers."
authorName: "OpenHRApp Team"
category: "Feature Guide"
publishedAt: "2026-02-08T06:02:00+00:00"
---

# A Guide to OpenHRApp's Performance Review Module

OpenHRApp's performance review module enables structured, multi-stage evaluations with customizable competencies and rating scales. Whether you are running annual appraisals, quarterly check-ins, or probation reviews, this guide walks you through the complete process.

## How does a review move from start to finish?
...
## How do you configure review settings?
...
## How do you create a review cycle?
...
## Which review type should you run?
...
## What makes a review cycle work?
...
- [OpenHRApp Reports and Analytics: Making Data-Driven HR Decisions](/blog/openhrapp-reports-analytics-guide) — Pull attendance and leave data into reviews and track performance trends over time.

*Set up your first performance review cycle in OpenHRApp today — completely free. [Start here](/).*
