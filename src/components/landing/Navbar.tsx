...
const Navbar: React.FC<NavbarProps> = ({ onLoginClick, onRegisterClick: _onRegisterClick }) => {
        ...
        <div className={dlShell.row}>
          ...
          <div className={dlBrand.trigger} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className={dlBrand.frame}>
              <img src="/img/ak_industries_logo.jpeg" className="w-full h-full object-contain" alt="A.K. Industries" width="48" height="48" />
            </div>
