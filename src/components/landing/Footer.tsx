      ...
      <div className={dlFooter.inner}>
          ...
          <div className={dlFooter.brandCol}>
            <div className="flex items-center gap-2 mb-4">
              <div className={dlBrand.frameSmall}>
                <img src="/img/ak_industries_logo.jpeg" className="w-full h-full object-contain" alt="A.K. Industries" width="44" height="44" />
              </div>
              <span className={dlBrand.word}>
                <span className={dlBrand.wordOnSlab}>A.K. </span>
                <span className={dlBrand.wordAccentOnSlab}>Industries</span>
              </span>
            </div>
            <p className={dlFooter.blurb}>
              A.K. Industries HR portal — manage attendance, leave, and employee records in one place.
            </p>
          </div>
        ...
        <div className={dlFooter.bottomBar}>
          <p className={dlFooter.fine}>
            &copy; {new Date().getFullYear()} A.K. Industries. All rights reserved.
          </p>
