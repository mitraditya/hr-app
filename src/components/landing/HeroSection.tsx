...
import { Clock, Zap, LogIn, Download, Share, MoreVertical, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-dl-teal/5 border border-dl-teal/15 rounded-full mb-6">
            ...
            <span className="text-dl-xs font-bold text-dl-teal uppercase tracking-dl-label">A.K. Industries — HR Management</span>
          </div>
          ...
          <h1 className="font-dl-display text-4xl sm:text-5xl lg:text-6xl font-semibold text-dl-ink tracking-dl-display leading-[1.1] mb-6">
            Welcome to{' '}
            <span className="text-dl-teal">A.K. Industries</span>
          </h1>

          {/* Subtext */}
          <p className="text-dl-lg sm:text-dl-xl text-dl-muted max-w-2xl mx-auto mb-10 leading-relaxed">
            A.K. Industries' HR platform — track attendance with selfie-based check-ins, manage leave requests with one click, and keep employee records organized, all from one intuitive dashboard.
          </p>
          ...
          <div className="mb-10">
            ...
            <p className="mt-5 text-dl-sm text-dl-muted max-w-xl mx-auto leading-relaxed">
              ...
              the whole job — everything else the platform does is built on getting those two
              timestamps right.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 mb-16">
            <div className="flex items-center gap-2 text-dl-muted">
              ...
              <span className="text-dl-xs font-semibold">Always available</span>
            </div>
            <div className="flex items-center gap-2 text-dl-muted">
          ...
          <div className="relative max-w-4xl mx-auto mb-16">
            <h2 className="font-dl-display text-dl-xl sm:text-dl-2xl font-semibold text-dl-ink tracking-dl-head mb-6">See the HR App in Action</h2>
